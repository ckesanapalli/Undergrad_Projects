clc
clear all
 B=zeros(243,320,11,15); A=zeros(243*320,11,15);C=zeros(243*320,10,15);
for subid= 1:15
    if(subid<10)
...
for subid=1:15
    ...
    n(subid)=norm(T(:,1,subid)'-A(:,11,test)'+Cm(:,1,subid)'); %since going ou of memory test photo has not been weighed using inverse of covariance matrix
